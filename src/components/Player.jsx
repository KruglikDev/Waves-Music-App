  ...
  const View = useCallback(() => {
    return (
      <div className='play-control'>
        ...
        >
          <input id='skip_previous' type='radio' name='radio_btns' className='visually-hidden' />
        ...
        >
          <input
            ...
            value={isPlaying}
          />
          <label htmlFor={isPlaying ? 'play' : 'pause'} className='content-wrapper'>
            {isPlaying ? (
        ...
        >
          <input id='skip_next' type='radio' name='radio_btns' className='visually-hidden' />
